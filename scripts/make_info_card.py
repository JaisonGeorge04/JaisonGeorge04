...
# ===========================================================================
HOST = "JaisonGeorge04"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Role", "Full-Stack Developer"),
    ("kv", "Focus", "Cloud, DevOps & ML"),
    ("kv", "Based", "Kerala, India"),
    ("gap",),
    ("sec", "Stack"),
    ...
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building and deploying real-world projects"),
    ("bul", "AI marketing, prediction, and management systems"),
]
